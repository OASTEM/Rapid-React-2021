...
public final class Constants {
    public static final int FRONT_LEFT_ID = 0; //was 3
    public static final int FRONT_RIGHT_ID = 1; //was 1
    public static final int BACK_LEFT_ID = 2; //was 2
    public static final int BACK_RIGHT_ID = 3; //was 0
